      ...
      <div className={`${styles.container}`}>
        ...
        <section className={styles.licenses}>
          ...
          <ContactCard
            ...
            type="active"
            description="<strong>RPS:</strong> 3 to unlimited <br /> <strong>Storage:</strong> 15 GB to unlimited<br /> <strong>Price:</strong> starting at $40"
            button={(
              <Button
                type="primary"
                styleClass={styles.licenseButton}
        ...
        <section className={styles.questionText}>
          <h2 className={styles.questionTitle}>{t('by.questitonTitle')}</h2>
          <h4 className={styles.description}>{t('by.questitonDescription')}</h4>
        </section>
        <section className={`${styles.questionDescription}`}>
          ...
          >
            <p>
              {t('by.descriptionMainCardP1')}
              <strong className={styles.cardListTitle}>{t('by.descriptionMainCardP2')}</strong>
              {t('by.descriptionMainCardP3')}
            </p>
            <ul className={styles.descriptionList}>
              <li>
                <span className={styles.cardListTitle}>
                  {t('by.descriptionMainCardListItem1Title')}
                </span>
                {t('by.descriptionMainCardListItem1')}
              </li>
              <li>
                <span className={styles.cardListTitle}>
                  {t('by.descriptionMainCardListItem2Title')}
                </span>
                {t('by.descriptionMainCardListItem2')}
              </li>
              <li>
                <span className={styles.cardListTitle}>
                  {t('by.descriptionMainCardListItem3Title')}
                </span>
          ...
          <div className={styles.cardList}>
            ...
            />
            <CardFAQ
              title={t('by.titleCard2')}
              description={t('by.descriptionCard2')}
              styleClass={styles.card2}
            />
            <CardFAQ
              title={t('by.titleCard3')}
              description={t('by.descriptionCard3')}
              styleClass={styles.card3}
            />
            <CardFAQ
              title={t('by.titleCard4')}
              description={t('by.descriptionCard4')}
              styleClass={styles.card4}
            />
          </div>
          <CardFAQ title={t('by.titleCard5')} styleClass={styles.card5}>
            <div>
              <div className={styles.descriptionSection}>
                <div className={styles.P1}>
                  <h5>{t('by.descriptionCard5P1')}</h5>
                  <ul className={`${styles.descriptionList} ${styles.descriptionListLicenses}`}>
                    <li>{t('by.descriptionMainCardP1ListItem1')}</li>
                    <li>{t('by.descriptionMainCardP1ListItem2')}</li>
                    <li>{t('by.descriptionMainCardP1ListItem3')}</li>
                  </ul>
                </div>
                <div className={styles.P2}>
                  <h5>{t('by.descriptionCard5P2')}</h5>
                  <ul className={`${styles.descriptionList} ${styles.descriptionListLicenses}`}>
                    <li>{t('by.descriptionMainCardP2ListItem1')}</li>
                    <li>{t('by.descriptionMainCardP2ListItem2')}</li>
                    <li>{t('by.descriptionMainCardP2ListItem3')}</li>
                  </ul>
                </div>
              </div>
          ...
          <div className={styles.cardList}>
            <CardFAQ
              title={t('by.titleCard6')}
              description={t('by.descriptionCard6')}
              styleClass={styles.card6}
            />
            <CardFAQ
              title={t('by.titleCard7')}
              description={t('by.descriptionCard7')}
              styleClass={styles.card7}
            />
          </div>
        </section>
      </div>
